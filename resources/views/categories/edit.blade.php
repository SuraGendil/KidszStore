        ...
        <div class="bg-[#1A255B] p-8 rounded-lg shadow-xl border border-gray-700">
            ...
            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" class="shadow appearance-none border border-gray-700 rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline bg-[#0e1a4b]" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-6">
                    ...
                    <select name="status" id="status" class="shadow appearance-none border border-gray-700 rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline bg-[#0e1a4b]">
                        ...
                        <option value="0" {{ old('status', $category->status) == 0 ? 'selected' : '' }}>Non-aktif</option>
                    </select>
                </div>
